...
import { useAluno, useAlunos, useJornada } from "@/hooks/index.js";
                    ...
                    <Flex width={"80%"} flexDirection={"column"} >
                        ...
                        <Card.Root borderRadius={5} padding={5}>
                            ...
                            <Flex mt={2} flexDirection={"row"} alignItems={"center"} justifyContent="space-between" >
                                <InputText value={nome} width='90%' name="nome" label="Nome" onChange={(e) => setNome(e.target.value)} />
                                <InputText value={idade} width='90%' name="idade" label="Idade" onChange={(e) => setIdade(e.target.value)} />
                            </Flex>
                            <Flex flexDirection={"row"} mt={3} alignItems={"center"} justifyContent="center" >
                                <InputText value={comum} width='90%' name="comum" label="Comum" onChange={(e) => setComum(e.target.value)} />
                                <InputText value={endereco} width='90%' name="Endereco" label="Endereço" onChange={(e) => setEndereco(e.target.value)} />
                            </Flex>
